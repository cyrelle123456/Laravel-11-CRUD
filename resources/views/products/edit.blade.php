                ...
                <div class="row">
                    <div class="col-md-7">
                        <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <input type="submit" class="col-md-6 offset-md-4 btn btn-primary" value="Update Product">
                            </div>
                        </form>
                    </div>
                    <div class="col-md-5 d-flex align-items-center justify-content-center">
                        ...
                        <div class="text-center w-100">
                            <img src="{{ $product->image_url }}" alt="Current Product Image" class="img-fluid rounded shadow" style="max-width: 100%; height: auto; max-height: 300px; object-fit: contain;">
                        </div>
                        @else
